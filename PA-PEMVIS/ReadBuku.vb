...
ds.Tables("tbbuku").Rows(i)(6), ds.Tables("tbbuku").Rows(i)(7), ds.Tables("tbbuku").Rows(i)(8), ds.Tables("tbbuku").Rows(i)(9))
    ...
    Private Sub BunifuThinButton23_Click(sender As Object, e As EventArgs) Handles btnTambah.Click
        AddBuku.Show()
        Me.Hide()
    End Sub

    Private Sub BunifuThinButton21_Click(sender As Object, e As EventArgs) Handles btnEdit.Click
...
WHERE idbuku = '" & idbuku & "';"
    ...
    Private Sub BunifuThinButton24_Click(sender As Object, e As EventArgs) Handles btnClear.Click
        clear()
    End Sub

    Private Sub BunifuThinButton22_Click(sender As Object, e As EventArgs) Handles btnHapus.Click
        cmd = New MySqlCommand("Select * From tbbuku where idbuku='" & idbuku & "'", con)
        rd = cmd.ExecuteReader
        rd.Read()
        If rd.HasRows Then
